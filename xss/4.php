    ...
    <div class="content">
        <form class="login-form" action="" method="POST">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (str_contains($comment, '<script>') || str_contains($username, '<script>')) {
                    echo '<label class="error">Dehors hacker !</label>';
                } else {
                    $stmt = $conn->prepare("INSERT INTO xss4 values (?, ?)");
